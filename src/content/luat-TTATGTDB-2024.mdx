...
<>
  <table style={{ fontSize: '16px' }}>
    <tbody>
      ...
      <tr style={{ border: 'none', backgroundColor: 'var(--bgColor-default)' }}>
        <td style={{ border: 'none' }}>Luật&nbsp;số: 36/2024/QH15</td>
        <td style={{ border: 'none', width: 600 }} />
  ...
  <div style={{ textAlign: "center", }}>
    <strong>LUẬT</strong>
    <br />
    <strong>TRẬT TỰ, AN TOÀN GIAO THÔNG ĐƯỜNG BỘ</strong>
  </div>
</>
...
<table>
  <tbody>
    <tr style={{ border: 'none' }}>
      <td style={{ border: 'none', textWrap: 'nowrap' }}>
        <div>
      ...
      <td style={{ border: 'none', width: 1000 }} />
