...
<DocumentHeading 
  title={
    <>
      THÔNG TƯ<br />
      Quy định về tốc độ và khoảng cách an toàn<br />
      của xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ<br />
      ---
    </>
  }
/>
...
<table>
  <tbody>
    <tr>
      <td rowSpan="2">Loại xe cơ giới đường bộ</td>
    ...
    <tr>
      <td>
        Đường **đôi**; <br />
        đường **một chiều** (≥ **2 làn xe** cơ giới)
      </td>
      <td>
        Đường **hai chiều**; <br />
        đường **một chiều** (**1 làn xe** cơ giới)
      </td>
    </tr>
    <tr>
      <td>
        Các phương tiện xe cơ giới, <br />
        trừ các xe được quy định tại Điều 8 Thông tư này.
      </td>
      <td>60</td>
      <td>50</td>
    </tr>
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        Xe ô tô con, <br />
        xe ô tô chở người đến 30 chỗ (trừ xe buýt); <br />
        xe ô tô tải (trọng tải ≤ 3,5 tấn).
      </td>
      <td>90</td>
      <td>80</td>
    </tr>
    <tr>
      <td>
        Xe ô tô chở người trên 30 chỗ (trừ xe buýt); <br />
        xe ô tô tải (trọng tải > 3,5 tấn, trừ ô tô xi téc).
      </td>
      <td>80</td>
      <td>70</td>
    </tr>
    <tr>
      <td>
        Ô tô buýt; <br />ô tô đầu kéo kéo sơ mi rơ moóc; <br />
        xe mô tô; <br />ô tô chuyên dùng (trừ ô tô trộn vữa, ô tô trộn bê tông).
      </td>
      <td>70</td>
      <td>60</td>
    </tr>
    <tr>
      <td>
        Ô tô kéo rơ moóc; <br />ô tô kéo xe khác; <br />ô tô trộn vữa, ô tô trộn
        bê tông, ô tô xi téc.
      </td>
      <td>60</td>
      <td>50</td>
...
<DocumentEnding 
  left={
    <div className="text-center">
      <div className="font-bold">BỘ GIAO THÔNG VẬN TẢI</div>
      <div>---</div>
      <div>Số: 12/VBHN-BGTVT</div>
    </div>
  }
  right={
    <div className="font-bold">
      <div>XÁC THỰC VĂN BẢN HỢP NHẤT</div><br />
      <div className="font-normal italic">Hà Nội, ngày 28 tháng 7 năm 2023</div>
      <div>KT. BỘ TRƯỞNG</div>
      <div>THỨ TRƯỞNG</div><br /><br />
      <div>Lê Đình Thọ</div>
    </div>
  }
/>
