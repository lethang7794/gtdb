...
| ----------------- | ---------------- | ---------- | ------------------------------ | ------------------------------------------------------ |
| B1 số tự động[^1] | ≤ 9 chỗ          | < 3.500 kg | Ô tô dùng cho người khuyết tật | Cấp cho người không hành nghề lái xe                   |
...
| C                 |                  | ≥ 3.500 kg |                                | và các loại xe quy định cho các GPLX[^5] hạng B1, B2   |
| D                 | ≤ 30 chỗ         |            |                                | và các loại xe quy định cho các GPLX hạng B1, B2, C    |
| E                 | > 30 chỗ         |            |                                | và các loại xe quy định cho các GPLX hạng B1, B2, C, D |

## Từ 1/1/2025[^7]

| Hạng | Xe ôtô chở người<br/>(không kể chỗ của người lái xe) | Xe ôtô tải và<br/>ô tô chuyên dùng[^2] | [^3] ... kéo rơ moóc[^4] | Xe khác                          | Ghi chú                                                    |
| ---- | ---------------------------------------------------- | -------------------------------------- | ------------------------ | -------------------------------- | ---------------------------------------------------------- |
...
[^1]: Khoản 5 Điều 16 Thông tư 12/2017/TT-BGTVT
[^2]: có khối lượng toàn bộ theo thiết kế
[^3]: Các loại xe ô tô quy định cho GPLX cùng hạng ...
[^4]: có khối lượng toàn bộ theo thiết kế
[^5]: Giấy phép lái xe
[^6]: Theo Luật Giao thông đường bộ 2008
[^7]: Theo Luật Trật tự, an toàn giao thông đường bộ 2024
