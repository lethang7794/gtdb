...
export const EXTRA_LINKS: {
  ...
  {
    name: 'Trang thông tin Giấy phép lái xe | Cục đường bộ Việt Nam',
    url: 'https://gplx.gov.vn/',
    description:
      'TRA CỨU THÔNG TIN Giấy phép lái xe: GPLX PET (có thời hạn, không thời hạn), GPLX cũ',
  },
  {
    name: 'Các Bản Đồ Đường Bộ Chuyên Biệt | Cục đường bộ Việt Nam',
