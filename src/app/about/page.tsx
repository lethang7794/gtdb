    ...
    <main className="grow flex flex-col justify-between p-6 md:p-8">
      <div className="container">
        ...
        <div className="mt-8 text-2xl text-gray-500">
          <Logo className="inline-block h-8 -mb-2" /> là dự án cá nhân{' '}
          <em>phi lợi nhuận</em> nhằm phổ biến các{' '}
          <b>kiến thức về an toàn giao thông đường bộ</b> đến tất cả mọi người
          dân tham gia giao thông ở Việt Nam.
        </div>
