...
export default function NghiDinh168HDSD() {
  return (
    <Dialog>
      <DialogTrigger>
        <div className="hover:border-gray rounded-md bg-white p-2 opacity-100 shadow-xs">
          ...
          <DialogDescription>
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-2">
                <div className="font-bold">1. Phần tóm tắt (sơ đồ tư duy)</div>
                <div className="mx-4">
              ...
              <div className="flex flex-col gap-2">
                <div className="font-bold">2. Đến Chương/Mục/Điều cụ thể:</div>
                <div className="ml-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="ml-4">
                  - Bước 1: Bấm vào nội dung Chuơng/mục/Điều/khoản/điểm cần chia
                  sẻ để hiện biểu tượng chia sẻ.
                </div>
                <div className="mr-4 ml-7">
                ...
                <div className="ml-4">
                  - Bước 2: Bấm vào biểu tượng chia sẻ để sao chép link đến đó.
                </div>
                <div className="mr-4 ml-7">
